...
public class PendingDetailsFragment extends Fragment {
    ...
    public static PendingDetailsFragment newInstance(ReservationModel RM, int position) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        textViewRemainingTimeReservation.setText(Integer.toString(RM.getRemainingMinutes()) + " min");
        ...
        customer_name.setText(Integer.toString(RM.getCustomerId()));
