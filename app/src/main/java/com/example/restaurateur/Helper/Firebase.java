package com.example.restaurateur.Helper;
...
public class Firebase extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fireimage);
...
//        manager.registerReceiver(mBroadcastReceiver, MyDownloadService.getIntentFilter());
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (mDownloadUrl != null) {
            ...
            Glide.with(this).load(mDownloadUrl).placeholder(R.drawable.img_rest_1).into((ImageView) findViewById(R.id.imageView));
